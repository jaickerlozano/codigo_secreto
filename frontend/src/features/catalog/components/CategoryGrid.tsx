          ...
          {categories.map((category) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'flex flex-col items-center gap-2.5 rounded-2xl border p-3 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
                  isActive
